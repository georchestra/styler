                        ...
                        success: function(form, action) {
                            ...
                            OpenLayers.Request.GET({
                                ...
                                success: function(response) {
                                    ...
                                    var clonedFilters = this.cloneFilter(loadedFilters.filter);
                                    if (clonedFilters.type === "&&") {
                                        this.findByType('combo')[0].setValue(Styler.FilterBuilder.ALL_OF);
                                        this.changeBuilderType(Styler.FilterBuilder.ALL_OF);
                                    } else if (clonedFilters.type === "||") {
                                        this.findByType('combo')[0].setValue(Styler.FilterBuilder.ANY_OF);
                                        this.changeBuilderType(Styler.FilterBuilder.ANY_OF);
                                    } else if (clonedFilters.type === "!") {
                                        this.findByType('combo')[0].setValue(Styler.FilterBuilder.NONE_OF);
                                        this.changeBuilderType(Styler.FilterBuilder.NONE_OF);
                                    }
