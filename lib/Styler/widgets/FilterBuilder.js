                            ...
                            OpenLayers.Request.GET({
                                ...
                                success: function(response) {
                                    ...
                                    var a = {
                                        ...
                                        "!": Styler.FilterBuilder.NONE_OF
                                    }, newType = a[clonedFilters.type];
                                    if (! newType === undefined) {
                                        this.findByType('combo')[0].setValue(newType);
                                        this.changeBuilderType(newType);
                                    }

                                    //TODO refactor spatial and comparaison case
                                    //clonedFilters is a logical filters
                                    ...
                                    // 1 comparison filter
                                    if (clonedFilters instanceof OpenLayers.Filter.Comparison) {
                                        this.addCondition("default", null, clonedFilters)
                                    // 1 spatial filter
                                    } else if (clonedFilters instanceof OpenLayers.Filter.Spatial) {
                                        var feature = new OpenLayers.Feature.Vector(
                                            clonedFilters.value, {}, this.vectorLayer.style);
                                        // Adding a feature to vectorLayer fire an addCondition
                                        // without the filter parameter
                                        // We manually remove the filter
                                        // and the row
                                        ...
                                        this.filter.filters[0].filters.pop();
                                        this.addCondition("spatial", feature, clonedFilters);
                                    }
